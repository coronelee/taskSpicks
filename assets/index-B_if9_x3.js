              ...
              P("span", null, [
                P(
                  "input",
                  {
                    type: "checkbox",
                    class:
                      "w-[20px] h-[20px] border rounded appearance-none border-[#fff] checked:border-none checked:bg-[#84D52C] checked:bg-[url('check.svg')] bg-center bg-no-repeat",
                    id: "100% Indica",
                    onChange:
...
const Hc = Qs(Sc, [
  ...
  ut = (e) => (Ks("data-v-27fa2f11"), (e = e()), qs(), e),
  ...
  Kc = ut(() =>
    P(
      "input",
      {
        type: "text",
        class:
          "outline-none h-[48px] bg-transparent text-[#959595] border border-[#959595] rounded-xl py-2 pl-12 pr-2 w-[300px] bg-search bg-no-repeat bg-left bg-[14px] bg-[length:20px_20px]",
        ...
        n = (s) => {
          t[s.target.id]
            ? (document
              ...
              (t[s.target.id] = !1))
            : (document.getElementById(s.target.id).classList.add("bg-primary"),
              (t[s.target.id] = !0));
        };
      return (s, r) => (
        mt(),
  ...
  iu = Qs(ou, [["__scopeId", "data-v-27fa2f11"]]),
